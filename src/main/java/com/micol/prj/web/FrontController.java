...
import com.micol.prj.command.QaDeleteForm;
...
import com.micol.prj.command.QaUpdate;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/qaDeleteForm.do", new QaDeleteForm());
		map.put("/qaUpdate.do", new QaUpdate());
		...
		// 댓글
		map.put("/addReply.do", new ReplyAdd());
		map.put("/deleteReply.do", new ReplyDelete());
