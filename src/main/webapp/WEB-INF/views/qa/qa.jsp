...
<body>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form class="col-md-9 m-auto" method="post"  action="qaList.do" role="form">
                <div class="row">
                ...
                <div class="mb-3">
                    <label for="inputsubject">내용</label>
                ...
                <div class="row">
                    <div class="col text-end mt-2">
                        <button type="submit" class="btn btn-success btn-lg px-3">문의사항입력</button>
                    </div>
                </div>
            </form>
        </div>
